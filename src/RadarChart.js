...
export const RadarChart2 = ({ data, id }) => {
...
//     // if (charts[gadgetId] && charts[gadgetId].node()) {
//     //   charts[gadgetId].remove();
//     // }
//     //
//     // // init g.container
//     // charts[gadgetId] = select(svgRef.current)
//     //     .append('g')
...
//     //     .attr('class', 'yAxis');
//     //
//     // // fill all elements by orderData
//     // drawChart();
//   };
//
//   return (
